/*=========================================================================
DO FILE NAME:			9_antidepress_heat-japan-01-stratify-antidepress-prep_sccs-program
...
DESCRIPTION OF FILE:	Identify study population using heat as an exposure in people prescribed antidepressant N06A
...
start from the first day of antidepressants, study start date (1/1/2014) and end at death date or study end date 31/12/2021, treatment discontinuation (Defined as >90 days gaps between Rx)
...
merge m:1 patid using "$datafile/antidepress_clean_drug_all_heatwave_drugcat", keep(master match) nogen

rename patid 加入者id
merge m:1 加入者id using "$datafile/psychotropic_drug_N06A_hc", keepusing (dob gender) keep(match) nogen
