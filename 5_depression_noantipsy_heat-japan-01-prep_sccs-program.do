/*=========================================================================
DO FILE NAME:			5_depression_noantisy_heat-japan-01-prep_sccs-program
...
log using "${pathLogs}/5_depression_noantisy_heat-japan-01-prep_sccs-program", text replace
*********************************************************************

/*****************************************************************
* 1. Create exposure intervals
*****************************************************************/	
use "$datafile/depression_heatwave_noantipsy", clear
...
save "$datafile/depression_nodrug_intervals", replace


/*****************************************************************/
* 4. append the antipsy dataset and the above dataset for running SCCS
*****************************************************************/
use "$datafile/depression_drug_intervals", clear
append using "$datafile/depression_nodrug_intervals"
...
save "$datafile/depression_all_intervals_final", replace
